...
const IndexPage = () => (
  <div className="container">
    ...
    <p>Bij Cocotte kan u ook terecht voor speciale gelegenheden zoals een Familiefeest, communie, bedrijfsfeest, seminaries, enz…</p>
    <p>Heeft u nog vragen of wilt u graag reserveren, neem dan gerust contact met ons op!</p>

    <h2>Bij ons kan u genieten...</h2>
  </div>
);
